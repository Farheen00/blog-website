...
export default function CommentSection() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg border border-gray-300 mt-9 mb-11">
      <h1 className="text-3xl font-semibold text-emerald-600 mb-4 text-center">
        Comment Section
      </h1>
      ...
      <div className="mb-4">
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full p-[10px] border-2 border-slate-750 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-950 mb-3"
          />
        </div>
        <div className="flex justify-between items-center">
          ...
          <input
            ...
            className="w-full p-[10px] border-2 border-slate-750 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-950"
          />
          <button
            onClick={addComment}
            disabled={!name || !comment}
            className="ml-4 px-6 py-3 bg-emerald-600 text-white rounded-md "
          >
            Add
          </button>
        </div>
      ...
      <div className="space-y-4">
        <ul>
          {commentlist.map((commentlist) => (
            <li
              className="flex justify-between items-center p-3 border-b border-gray-500 rounded-md hover:bg-slate-100"
              key={commentlist.id}
            >
